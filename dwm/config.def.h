...
static char col_black[] 		          = "#1a1b26";
static char col_gray[] 		              = "#15161e";
static char col_blue[] 		              = "#7aa2f7";
static char col_orange[] 		          = "#ff9e64";
static char col_red[] 		              = "#f7768e";
static char col_pink[] 		              = "#ff007c";
static char col_green[] 		          = "#9ece6a";
static char col_cyan[] 		              = "#7dcfff";
static char col_yellow[] 		          = "#9ece6a";
static char col_magenta[] 	              = "#bb9af7";
static char col_white[] 	 	          = "#c0caf5";
...
static char termcol16[]  = "#808080"; /* gray    */
static char termcol17[]  = "#ff0099"; /* pink    */
static char termcol18[]  = "#ffa500"; /* orange  */
...
const char *spcmd1[] = { TERMINAL, "-n", "spterm", "-g", "140x35", NULL };
const char *spcmd2[] = { TERMINAL, "-n", "spfm",   "-g", "140x35", "-e", "yazi", NULL };
const char *spcmd3[] = { TERMINAL, "-n", "spmus",  "-g", "140x35", "-e", "rmpc", NULL};
